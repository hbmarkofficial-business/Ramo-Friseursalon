  ...
  return (
    <>
      <Helmet>
        ...
        <title>Friseursalon Bielefeld | Ramo Friseursalon</title>
        <meta
          name="description"
          content="Besuche unseren Premium Friseursalon Ramo Friseursalon in Bielefeld für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Ramo Friseursalon | Premium Friseursalon Bielefeld" />
        <meta
        ...
        <meta name="twitter:title" content="Ramo Friseursalon | Premium Friseursalon Bielefeld" />
        <meta
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "sameAs": [
              "https://www.facebook.com/ramofriseur",
              "https://www.instagram.com/ramofriseur"
            ]
          })}
        </script>
      </Helmet>
